...
export interface RdsOptions {
  ...
  /**
   * Specifies if the replica should be cross region. It allows the use of a subnet group in a region different than the master instance
   */
  readonly crossRegionReplica?: boolean;
  /**
...
export class Rds extends TerraformModule {
  ...
  public constructor(scope: Construct, id: string, options: RdsOptions) {
    super(scope, id, {
    ...
    this.crossRegionReplica = options.crossRegionReplica;
    ...
    this.monitoringRoleDescription = options.monitoringRoleDescription;
    ...
    this.restoreToPointInTime = options.restoreToPointInTime;
  ...
  public get crossRegionReplica(): boolean | undefined {
    return this.inputs['cross_region_replica'] as boolean | undefined;
  }
  public set crossRegionReplica(value: boolean | undefined) {
    this.inputs['cross_region_replica'] = value;
  }
  ...
  public get dbMasterPasswordOutput() {
    return this.getString('db_master_password')
  }
